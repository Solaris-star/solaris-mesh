...
This document defines the runtime units used by Solaris CLI. These terms matter
...
If a user asks Solaris CLI to inspect and edit a file, one run might contain:
