...
This document defines the runtime units used by Solaris Mesh. These terms matter
...
If a user asks Solaris Mesh to inspect and edit a file, one run might contain:
