...
use solaris_config::compat::{self, ProviderCompat, ToolWireShape};
use solaris_config::schema::legalize_json_schema;
use solaris_types::llm::{LlmRequest, ThinkingConfig};
use solaris_types::tool::{ToolDef, truncate_deferred_description};
use std::fmt;
