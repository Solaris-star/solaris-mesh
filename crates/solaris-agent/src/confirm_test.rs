...
mod tests {
    ...
    fn test_auto_approve_always_allows() {
        ...
        assert_eq!(
            ...
            ConfirmResult::ApprovedAlways
        );
        assert_eq!(confirmer.check("Read", "/tmp/file"), ConfirmResult::ApprovedAlways);
        assert_eq!(confirmer.check("Write", "/tmp/out"), ConfirmResult::ApprovedAlways);
    }
    ...
    fn test_allowlist_approves_even_when_auto_approve_is_false() {
        ...
        assert_eq!(confirmer.check("Read", "/some/path"), ConfirmResult::ApprovedAlways);
    }
    ...
    fn test_add_to_allow_list_grants_approval() {
        ...
        assert_eq!(confirmer.check("Write", "file.txt"), ConfirmResult::ApprovedAlways);
    }
    ...
    fn test_add_to_allow_list_idempotent() {
        ...
        assert_eq!(confirmer.check("ExecCommand", "echo hi"), ConfirmResult::ApprovedAlways);
    }
    ...
    fn test_add_to_allow_list_does_not_affect_other_tools() {
        ...
        assert_eq!(confirmer.check("Read", "file.txt"), ConfirmResult::ApprovedAlways);
