...
use solaris_config::shell::{ResolvedShell, default_shell, render_shell_prompt};
use solaris_memory::prompt::build_memory_prompt_minimal;
use solaris_skills::prompt::format_skills_within_budget;
...
pub fn build_system_prompt_with_shell(
    ...
    if toon_enabled {
        let toon_section = cache
            .sections
            .entry("toon")
            .or_insert_with(|| solaris_compact::toon_format_instructions().to_string());
